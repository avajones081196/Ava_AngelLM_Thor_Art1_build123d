...
BUILD123D_STL = os.path.join(BASE_DIR, "Art1Top_Splitted_A_G_1_20.stl")
FUSION_STL    = os.path.join(BASE_DIR, "Art1Top_Splitted_A_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "Art1Top_Splitted_A_build123d_vs_original_G_1_20.txt")
