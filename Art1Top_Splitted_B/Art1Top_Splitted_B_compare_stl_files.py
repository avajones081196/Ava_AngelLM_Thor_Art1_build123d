...
BUILD123D_STL = os.path.join(BASE_DIR, "Art1Top_Splitted_B_G_1_6.stl")
FUSION_STL    = os.path.join(BASE_DIR, "Art1Top_Splitted_B_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "Art1Top_Splitted_B_build123d_vs_original_G_1_6.txt")
